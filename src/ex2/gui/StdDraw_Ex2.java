 ...
 *  @author Kevin Wayne
 */
public final class StdDraw_Ex2 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static StdDraw_Ex2 std = new StdDraw_Ex2();
	...
	private static Ex2 _ex2 = Ex2.getInstance();
	...
	private static void init() {
		...
		getFrame().setTitle("Ex2 I2CS (Ariel) Demo Solution V0.1 (uses Standard Draw)");
	...
	private static Image getImage(String filename) {
		...
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = StdDraw_Ex2.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	...
	/**	if(ev.equals("Save")) {
		FileDialog chooser = new FileDialog(StdDraw_Ex2.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
		chooser.setVisible(true);
		String filename = chooser.getFile();
		if (filename != null) {
			StdDraw_Ex2.save(chooser.getDirectory() + File.separator + chooser.getFile());
		}
		}*/
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = StdDraw_Ex2.userX(e.getX());
			mouseY = StdDraw_Ex2.userY(e.getY());
			isMousePressed = true;
			int b = e.getButton();
			System.out.println("Mouse: "+mouseX+","+mouseY+b);
			
			if(b==1) {
				_ex2.mouseClicked(new Point_2D(mouseX, mouseY));
			}
			if(b==3) {
	 ...
	 */
	public static void main(String[] args) {
		StdDraw_Ex2.square(0.2, 0.8, 0.1);
		StdDraw_Ex2.filledSquare(0.8, 0.8, 0.2);
		StdDraw_Ex2.circle(0.8, 0.2, 0.2);

		StdDraw_Ex2.setPenColor(StdDraw_Ex2.BOOK_RED);
		StdDraw_Ex2.setPenRadius(0.02);
		StdDraw_Ex2.arc(0.8, 0.2, 0.1, 200, 45);

		// draw a blue diamond
		StdDraw_Ex2.setPenRadius();
		StdDraw_Ex2.setPenColor(StdDraw_Ex2.BOOK_BLUE);
		double[] x = { 0.1, 0.2, 0.3, 0.2 };
		double[] y = { 0.2, 0.3, 0.2, 0.1 };
		StdDraw_Ex2.filledPolygon(x, y);

		// text
		StdDraw_Ex2.setPenColor(StdDraw_Ex2.BLACK);
		StdDraw_Ex2.text(0.2, 0.5, "black text");
		StdDraw_Ex2.setPenColor(StdDraw_Ex2.WHITE);
		StdDraw_Ex2.text(0.8, 0.8, "white text");
		
		StdDraw_Ex2.setPenColor(StdDraw_Ex2.BOOK_BLUE);
		StdDraw_Ex2.rectangle(0.5, 0.7, 0.2, 0.1);
		double[] xx = {0.2,0.4,0.5};
		double[] yy = {0.8,0.4,0.5};
		StdDraw_Ex2.filledPolygon(xx, yy);
		StdDraw_Ex2.ellipse(0.7, 0.5, 0.2, 0.1);
	}
